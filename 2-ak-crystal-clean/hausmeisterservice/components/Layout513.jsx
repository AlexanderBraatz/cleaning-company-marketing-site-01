          ...
          <div className="flex flex-col gap-y-16 md:sticky md:top-20 md:mt-20 md:h-[calc(100vh_-10rem)] md:justify-center">
            <div className="flex flex-col">
              ...
              <h2 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
                Warum AK Crystal Clean für Ihre Immobilie
              </h2>
              <p className="md:text-md">
                Wir bieten mehr als nur Reinigung. Unser Hausmeisterservice ist
                die Lösung für alle Aufgaben rund um Ihre Immobilie mit
                ...
                <Fragment>
                  <ConditionalRender condition={render.isMobile}>
                    <div>
                      ...
                      <p>
                        Wir reagieren schnell auf Anfragen und Notfälle, damit
                        Ihre Immobilie immer optimal läuft.
                      </p>
                      <div className="mt-4">
                        <img
                          src="https://d22po4pjz3o32e.cloudfront.net/placeholder-image-1.svg"
                ...
                <Fragment>
                  <ConditionalRender condition={render.isMobile}>
                    <div>
                      ...
                      <p>
                        Zertifizierte Methoden und moderne Technik garantieren
                        höchste Qualität bei jedem Einsatz.
                      </p>
                      <div className="mt-4">
                        <img
                          src="https://d22po4pjz3o32e.cloudfront.net/placeholder-image-3.svg"
