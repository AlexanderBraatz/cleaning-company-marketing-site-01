    ...
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        <div className="mx-auto mb-12 max-w-lg text-center md:mb-18 lg:mb-20">
          <p className="mb-3 font-semibold md:mb-4">Hausmeisterservice</p>
          <h1 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
            Umfassende Betreuung für Ihre Immobilie
          </h1>
          <p className="md:text-md">
            Unser Hausmeisterservice ist die Lösung für alle Aufgaben rund um
            Ihre Immobilie. Mit erfahrenen Fachleuten vor Ort kümmern wir uns um
            alles, damit Sie sich auf das Wesentliche konzentrieren können.
          </p>
          <div className="mt-6 flex flex-wrap items-center justify-center gap-4 md:mt-8">
            <Button title="Leistungen ansehen" variant="secondary">
              Leistungen ansehen
            </Button>
            <Button
              title="Kontakt"
            ...
            >
              ...
              >
                <p className="mt-3 md:mt-4">
                  Grünanlagen, Wege und Plätze werden regelmäßig gepflegt und
                  instand gehalten. Wir sorgen dafür, dass Ihre Außenbereiche
                  immer ansehnlich und sicher sind.
                </p>
              </motion.div>
            </div>
            <div
