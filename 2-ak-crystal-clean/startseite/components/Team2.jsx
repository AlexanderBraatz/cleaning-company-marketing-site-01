		...
		>
			<div className="container">
				<div className="mx-auto mb-12 max-w-lg text-center md:mb-18 lg:mb-20">
					<p className="mb-3 font-semibold md:mb-4 bg-amber-300 text-amber-700 ">
						Team
					</p>
					<h2 className="rb-5 mb-5 text-5xl font-bold bg-amber-300 text-amber-700  md:mb-6 md:text-7xl lg:text-8xl">
						Unser Team Testing
					</h2>
