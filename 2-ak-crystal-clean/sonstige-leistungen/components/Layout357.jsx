              ...
              <div className="container">
                ...
                <div className="py-8 md:py-10 lg:py-12">
                  <div className="grid grid-cols-1 gap-y-12 md:items-center md:gap-x-12 lg:grid-cols-2 lg:gap-x-20">
                    <div>
                      <p className="mb-3 font-semibold md:mb-4">Anpassung</p>
                      <h2 className="rb-5 mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
                        Wir passen uns Ihren Anforderungen an
                      </h2>
                      <p className="md:text-md">
                        Jede Aufgabe ist unterschiedlich. Wir entwickeln
                        maßgeschneiderte Reinigungskonzepte, die genau zu Ihren
                        Bedürfnissen passen und Ihre Erwartungen erfüllen.
                      </p>
