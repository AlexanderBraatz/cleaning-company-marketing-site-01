    ...
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        <div className="mx-auto mb-12 max-w-lg text-center md:mb-18 lg:mb-20">
          <p className="mb-3 font-semibold md:mb-4">Warum reinigen</p>
          <h1 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
            Ihr Dach verdient professionelle Pflege
          </h1>
          <p className="md:text-md">
            Ein sauberes Dach schützt Ihr Gebäude und erhöht seine Lebensdauer.
            Wir entfernen Verschmutzungen, die zu Schäden führen können.
          </p>
            ...
            >
              ...
              >
                <p className="mt-3 md:mt-4">
                  Ein gepflegtes Dach trägt zum Gesamtwert Ihrer Immobilie bei.
                  Regelmäßige Reinigung verhindert teure Reparaturen und
