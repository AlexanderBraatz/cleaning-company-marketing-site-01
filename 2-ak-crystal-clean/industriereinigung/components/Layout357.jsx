              ...
              <div className="container">
                ...
                <div className="py-8 md:py-10 lg:py-12">
                  <div className="grid grid-cols-1 gap-y-12 md:items-center md:gap-x-12 lg:grid-cols-2 lg:gap-x-20">
                    <div>
                      <p className="mb-3 font-semibold md:mb-4">Effizienz</p>
                      <h2 className="rb-5 mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
                        Ihre Produktion läuft weiter
                      </h2>
                      <p className="md:text-md">
                        Wir koordinieren unsere Arbeiten mit Ihren
                        Betriebszeiten. Nachts, am Wochenende oder in Schichten
                        – wir passen uns an, damit Ihre Produktion nicht
                        stillsteht.
                      </p>
