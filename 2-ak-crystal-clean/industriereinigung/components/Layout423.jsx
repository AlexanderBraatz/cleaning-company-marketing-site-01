    ...
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        <div className="mx-auto mb-12 w-full max-w-lg text-center md:mb-18 lg:mb-20">
          <p className="mb-3 font-semibold md:mb-4">Spezialisierung</p>
          <h2 className="rb-5 mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
            Maschinen und Produktionsanlagen
          </h2>
          <p className="md:text-md">
            Wir reinigen Ihre Maschinen und Produktionsanlagen mit Präzision und
            Sorgfalt. Unsere Spezialisten kennen die sensiblen Komponenten und
            arbeiten ohne Beschädigungen.
          </p>
        </div>
        <div className="flex flex-col justify-between gap-6 md:gap-8 lg:flex-row">
          ...
          >
            ...
            <div className="group relative flex h-full min-h-[70vh] flex-col justify-end p-6 md:p-8">
              ...
              <div className="z-10">
                <p className="mb-2 font-semibold text-text-alternative">Mehr</p>
                ...
                <div className="lg:hidden">
                  <p className="mt-5 text-text-alternative md:mt-6">
                    Großflächen verlangen Erfahrung. Wir reinigen Ihre
                    Hallenboden gründlich und effizient, damit Ihre
                    Arbeitsumgebung sauber und sicher bleibt.
                  </p>
