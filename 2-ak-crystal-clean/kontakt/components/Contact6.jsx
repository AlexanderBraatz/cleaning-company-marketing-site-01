      ...
      <div className="container grid grid-cols-1 items-start gap-y-12 md:grid-flow-row md:grid-cols-2 md:gap-x-12 lg:grid-flow-col lg:gap-x-20 lg:gap-y-16">
        <div>
          <div className="mb-6 md:mb-8">
            <p className="mb-3 font-semibold md:mb-4">Anfrage</p>
            <h2 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
              Kontaktieren Sie uns
            </h2>
            <p className="md:text-md">
              Füllen Sie das Formular aus und wir melden uns schnell zurück
            </p>
          </div>
          <div className="grid grid-cols-1 gap-4 py-2">
            ...
            <div className="flex items-center gap-4">
              ...
              <p>+49 (0) 6051 123456</p>
            </div>
            <div className="flex items-center gap-4">
              <BiMap className="size-6 flex-none" />
              <p>Gründau, Hessen, Deutschland</p>
            </div>
          </div>
        </div>
        <form className="grid max-w-lg grid-cols-1 grid-rows-[auto_auto] gap-6">
          ...
          <div className="grid w-full items-center">
            <Label className="mb-2">Gewünschte Leistung</Label>
            <Select>
              <SelectTrigger>
          ...
          <div className="grid w-full items-center py-3 md:py-4">
            <Label className="mb-3 md:mb-4">Wie können wir helfen?</Label>
            <RadioGroup className="grid grid-cols-2 gap-x-6 gap-y-3.5">
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="Geschäftsgebäude" id="#first_choice" />
                <Label htmlFor="#first_choice">Geschäftsgebäude</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="First choice" id="#second_choice" />
                <Label htmlFor="#second_choice">Privathaushalt</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="First choice" id="#third_choice" />
                <Label htmlFor="#third_choice">Industrieanlage</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="First choice" id="#fourth_choice" />
                <Label htmlFor="#fourth_choice">Sonstiges</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="First choice" id="#fifth_choice" />
                <Label htmlFor="#fifth_choice">Regelmäßig</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="First choice" id="#other" />
                <Label htmlFor="#other">Einmalig</Label>
              </div>
            </RadioGroup>
          </div>
          <div className="grid w-full items-center">
