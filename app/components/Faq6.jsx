	...
	return (
		...
		>
			<div className="container grid grid-cols-1 gap-y-12 md:grid-cols-2 md:gap-x-12 lg:grid-cols-[.75fr,1fr] lg:gap-x-20">
				...
				<Accordion
					type="multiple"
					className="grid items-start justify-stretch gap-4 lg:col-start-2 "
				>
					<AccordionItem
						value="item-0"
						className="border-0 bg-foreground px-5 md:px-6"
					>
						<AccordionTrigger
							icon={
