...
export function Navbar1() {
	...
	return (
		<section
			id="relume"
			className="flex fixed top-0 left-0 z-10 w-full items-center border-b theme-color-scheme-2  text-text-primary border-border-primary bg-background-primary lg:min-h-18 lg:px-[5%]"
		>
